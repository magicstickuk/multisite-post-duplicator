...
*   Copies post taxonomies. (Can be turned on or off in Settings). This behaviour assumes that the taxonomies being duplicated are registered on the destination site.
*	Batch Duplication
